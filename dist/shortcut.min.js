"use strict";exports.__esModule=true;;var SHORTCUTS_MODULES=["meta","ctrl","shift","alt"];var KeyboardShortcut=(function(){function KeyboardShortcut(){this._D=document.body;this._listeners={};this._keydownHandler=this._keydownHandler.bind(this);}
KeyboardShortcut.prototype._keydownHandler=function(e){var code=(e.code||e.key),keyCode=code.substring(code.startsWith("Key")?3:0),keys=[],filter=[16,17,18,91,93];e.metaKey&&keys.push('meta');e.ctrlKey&&keys.push('ctrl');e.shiftKey&&keys.push('shift');e.altKey&&keys.push('alt');if(filter.filter(function(n){return n===e.keyCode;}).length==0)
keys.push(keyCode.toLowerCase());var k=keys.join("+"),l=this._listeners[k];if(l){e.hotKeys=k;l(e),l.propagate&&e.stopPropagation(),e.preventDefault();}};KeyboardShortcut.prototype.get=function(){var len=arguments.length,ar=arguments,t=this;var el=this._D,call,isDone=false,sequence={};if(len===2){el=ar[0],call=ar[1];}
...
var h=[];k.meta&&h.push('meta');k.ctrl&&h.push('ctrl');k.shift&&h.push('shift');k.alt&&h.push('alt');h.push(k.code.toLowerCase());return h.join("+");};KeyboardShortcut.prototype._element=function(el){return typeof(el)==="string"?document.querySelector(el):el;};return KeyboardShortcut;}());var ListenKeys=new KeyboardShortcut();exports["default"]=ListenKeys;